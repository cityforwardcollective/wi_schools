...
public_files <- list.files(path = "./data/enrollment/public")
...
for(file in public_files) {
  ...
  filename <- paste("data/enrollment/public", file, sep = "/") 
...
private_files <- list.files(path = "./data/enrollment/private")
...
for(file in private_files) {
  ...
  filename <- paste("data/enrollment/private", file, sep = "/") 
